[![mist logo](http://assets.microbox.rocks/readme-headers/mist.png)](http://microbox.cloud/open-source#mist)  
[![Build Status](https://travis-ci.org/mu-box/mist.svg)](https://travis-ci.org/mu-box/mist)
...
``` json
{
  "tags": ["company:pagodabox", "product:mist", "repo:#mu-box"],
